...
'
SetupOptions = "/quiet RUNNOW=1 ADDLOCAL=full ADD_FIREWALL_EXCEPTION=1 DEBUG=level EXECMODE=1 HTML=1 TAG=%empresa% TASKS="" LOCAL=C:\Tools\ SERVER='https://innerbit.dyndns.info/glpi/front/inventory.php'"
