...
REM Cliente
			...
			REM Instalar Fusion
				...
				echo.   
					...
					GLPI-Agent-1.5-x64.msi /quiet RUNNOW=1 SERVER='https://suporte.innerbit.com.br/marketplace/glpiinventory, https://suporte.innerbit.com.br/front/inventory.php' RUNNOW=1 ADDLOCAL=ALL ADD_FIREWALL_EXCEPTION=1 AGENTMONITOR=1 DEBUG=level HTML=1 TASKS="" LOCAL=C:\Tools\
